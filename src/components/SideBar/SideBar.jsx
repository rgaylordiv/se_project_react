        ...
        <div>
            <div className="sidebar">
                {isLoggedIn ? (
                    ...
                    <>
                        <img className="sidebar__avatar" src={avatarPlaceholder} alt="Avatar Logo"/>
                        <p className="sidebar__name">Guest</p>
                    </>
                )}
            </div>
            <button className="sidebar__change-button" type="button" onClick={handleChangeClick}>
                {isLoggedIn ? 'Change profile data' : ''}
            </button>
            <button className="sidebar__log-button" type="button" onClick={handleLogOut}>Log Out</button>
        </div>
    )
}
